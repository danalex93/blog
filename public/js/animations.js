init = function(){
      ...
      jarallax.addAnimation('#head1',[{progress: "10%", left:"100px"}, {progress: "20%", left: "150px"}]);
      ...
      jarallax.addAnimation('#head2',[{progress: "30%", left:"100px"}, {progress: "40%", left: "150px"}]);
      ...
      // 40 - 60
      jarallax.addAnimation('#head3',[{progress: "40%", left:"-800px"}, {progress: "50%", left: "100px"}]);
      jarallax.addAnimation('#head3',[{progress: "50%", left:"100px"}, {progress: "60%", left: "150px"}]);
      ...
      // 60 - 80
      jarallax.addAnimation('#head4',[{progress: "60%", left:"-800px"}, {progress: "70%", left: "100px"}]);
      jarallax.addAnimation('#head4',[{progress: "70%", left:"100px"}, {progress: "80%", left: "150px"}]);
      ...
      // 80 - 100
      jarallax.addAnimation('#head5',[{progress: "80%", left:"-800px"}, {progress: "90%", left: "100px"}]);
      jarallax.addAnimation('#head5',[{progress: "90%", left:"100px"}, {progress: "100%", left: "150px"}]);
